...
wingetcreate update DimonSmart.NugetMcpServer --urls "https://github.com/DimonSmart/NugetMcpServer/releases/download/v$version/nuget-mcp-server-win-x64-$version.zip"
